...
INSERT INTO `ques_ans` VALUES (1,'What is out national animal','Tiger','Elephant','Peocock','Pegion','Tiger',1,NULL,NULL),(2,'Grand Central Terminal, Park Avenue, New York is the world\'s','largest railway station','longest railway station','highest railway station','None of the above','largest railway station',1,NULL,NULL),(3,'Entomology is the science that studies','Behavior of human beings','Insects','The origin and history of technical and scientific terms','The formation of rocks','Insects',1,NULL,NULL),(4,'For which of the following disciplines is Nobel Prize awarded?','Physics and Chemistry','Physiology or Medicine','Literature, Peace and Economics','All of the above','All of the above',1,NULL,NULL);
...
-- Dump completed on 2017-01-17  0:07:59
